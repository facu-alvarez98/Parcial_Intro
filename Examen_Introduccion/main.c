...
int main(void)
{
    ...
    char salir;
    short validacion_cargo=0;
    short validacion_acomp=0;
    short verificacion_acomp=0;// variable utilizada para que no ingresen mas acomp de los que cargo el usuario
    short suma=0;
    short cont_invitados=0;
    short cont_docente=0;
    short porc_ocupado=0;
                ...
                cont_invitados++;
                 ...
                 printf("Ingrese dni: ");
                  ...
                  scanf("%2[dajoDAJO][^\n]s",invitado[indice].cargo);/*para que si el usuario ingrese otro caracter no pueda seguir y si
                                                                      ingresa mas de un caracter solo se gaurde el primero, ademas, se le agrega su respectiva mayus a
                                                                       cada letra por si el usuario tiene el teclado en mayuscula*/
                  fflush(stdin);
            ...
            suma=suma-cont_invitados;
             ...
             do{
                    ...
                    printf("Ingrese DNI: ");
                     ...
                     while(strcmp(invitado[indice].dni,dni_buscado)!=0 && indice<cant)
                     {
                        indice++;
                     }
